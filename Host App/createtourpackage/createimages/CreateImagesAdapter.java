...
public class CreateImagesAdapter extends RecyclerView.Adapter<CreateImagesAdapter.v_holder> {
    ...
    public CreateImagesAdapter(Context mContext, ArrayList<String> arrayList) {
            ...
            public void onClick(View v) {
                if (position == (arrayList.size()-1)) {
                    if(mCallback != null){
                        ...
                        mCallback.onHandleSelection(position, data);
                    }
                }
            }
        });
