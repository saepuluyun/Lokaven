...
public class CreateVideosAdapter extends RecyclerView.Adapter<CreateVideosAdapter.v_holder> {
    ...
    public CreateVideosAdapter(Context mContext, List<MediasItem> arrayList) {
